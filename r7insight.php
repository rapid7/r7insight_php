...
***********/
	...
	$LOG_TOKEN = "83812fd2-61ba-48f5-988d-0287cdf62e7a";
...
************/
	...
	$log = LeLogger::getLogger($LOG_TOKEN, $REGION, $Persistent, $SSL, $Severity, $DATAHUB_ENABLED, $DATAHUB_IP_ADDRESS, $DATAHUB_PORT, $HOST_ID, $HOST_NAME, $HOST_NAME_ENABLED, $ADD_LOCAL_TIMESTAMP, $USE_JSON);